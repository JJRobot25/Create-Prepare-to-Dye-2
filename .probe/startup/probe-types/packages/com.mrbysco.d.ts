declare module "packages/com/mrbysco/anotherliquidmilkmod/block/$FlowingMilkBlock" {
...
export class $FlowingMilkBlock extends $LiquidBlock {
 ...
 */
export type $FlowingMilkBlock$Type = ($FlowingMilkBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $FlowingMilkBlock_ = $FlowingMilkBlock$Type;
}}
